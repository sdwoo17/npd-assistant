...
상품 기획자를 위한 **문서 분석·FGI·선진사례·선택적 VoC → 검토 결과 저장 → PRD 입력 선택** 워크스페이스입니다. 기본 AI 제공자는 AWS Bedrock Converse이며 OpenAI Responses API도 명시적으로 선택할 수 있습니다.
...
2026-09-15 PDF 개선 요건 반영: 기존 서비스 문서의 필드 자동 채움과 맥락 인터뷰, 페르소나 후보 선택, 완료 FGI 후속 대화, 실제 VoC 분석 제한, 저장 결과의 공통 검색과 PRD 버전 선택을 새 작업 화면으로 연결했습니다. [파일별 구현·API 변경·검증 범위](docs/research-flow-2026-09-15.md)를 확인하세요.
...
기존 서비스 PRD를 분석해 PO 인터뷰와 후속 PRD로 연결하는 방법은 [상세 리서치·인터뷰 안내](docs/existing-service-research-2026-09-15.md)를 참고하세요.
